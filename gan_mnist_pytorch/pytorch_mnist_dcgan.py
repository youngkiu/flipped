...
for epoch in range(train_epoch):
    ...
    for x_, _ in train_loader:
        ...
        x_, y_real_, y_fake_ = Variable(x_.cuda()), Variable(
    ...
    p = 'MNIST_DCGAN_results/Random_results/MNIST_DCGAN_' + \
        str(epoch + 1) + '.png'
    fixed_p = 'MNIST_DCGAN_results/Fixed_results/MNIST_DCGAN_' + \
        str(epoch + 1) + '.png'
...
print("Avg per epoch ptime: %.2f, total %d epochs ptime: %.2f" % (torch.mean(
...
show_train_hist(train_hist, save=True,
                path='MNIST_DCGAN_results/MNIST_DCGAN_train_hist.png')

images = []
for e in range(train_epoch):
    img_name = 'MNIST_DCGAN_results/Fixed_results/MNIST_DCGAN_' + \
        str(e + 1) + '.png'
